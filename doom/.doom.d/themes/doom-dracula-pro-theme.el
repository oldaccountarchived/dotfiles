...
(def-doom-theme doom-dracula-pro
  ...
  ((bg         '("#212C2A" "#262626" nil            ))
   ...
   (teal       '("#8be9fd"  "#0189cc" "#0088cc" "brightgreen"  ))
   (yellow     '("#ffff80" "#ffff88" "yellow"       ))
   (blue       '("#9580FF" "#66bbff" "brightblue"   ))
   (dark-blue  '("#0189cc" "#0088cc" "blue"         ))
   (magenta    '("#ff80bf" "#ff77cc" "magenta"      ))
   (violet     '("#9580FF" "#bb99ff" "brightmagenta"))
